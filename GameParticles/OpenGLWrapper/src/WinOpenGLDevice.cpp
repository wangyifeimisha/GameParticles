...
#else
	glClearColor(219.0f / 255.0f, 240.0f / 255.0f, 190.0f / 255.0f, 1.0f);
#endif
...
bool OpenGLDevice::privInitWindow()
{
	...
	wc.lpszClassName = "CSC 461: Fall 2022";//title.getCString();					// Set The Class Name
	...
	hWnd = CreateWindowEx(dwExStyle,				// Extended Style For The Window
		"CSC 461: Fall 2022",//title.getCString(),				// Class Name
		"CSC 461: Fall 2022",//title.getCString(),					// Window Title
...
bool OpenGLDevice::privKillWindow()
{
	...
	if(!UnregisterClass("CSC 461: Fall 2022", hInstance))
